					...
					<div class="popup-window portfolio-work">
						...
						<div class="portfolio-work-detail">
							...
							<!--<div class="links-box">
								...
								<a href="https://pinterest.com/pin/create/button/?url=<?php the_permalink();?>&media=<?php the_title();?>&description=<?php the_title();?>" target="blank"><img alt="<?php esc_html_e('pinterest','bs-smarty')?>"																																																src="<?php echo BravoAssets::$asset_url; ?>/images/share/pinterest.png"></a>
							</div> -->
						</div>
...
<section  class="single-page">
	<div class="section-content ">
		<div class="container">
			<div class="clearfix">
				<h1 class="page-top-heading pull-left"><?php echo esc_html__('Proyectos','bs-smarty')?></h1>
			...
			<!--	<ul id="isotope-filter-list3" class="pull-right filter-list-alt">
				...
				<div id="portfolio3" class="portfolio-layout8 row">
				<?php
					while ( $query->have_posts() ) {
						$query->the_post();
						$term_class = '';
